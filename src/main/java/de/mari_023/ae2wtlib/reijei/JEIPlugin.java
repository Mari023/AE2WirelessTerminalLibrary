...
public class JEIPlugin implements IModPlugin {
    ...
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        registration.addRecipeTransferHandler(
                new UseCraftingRecipeTransfer<>(WCTMenu.class, WCTMenu.TYPE, registration.getTransferHelper()), RecipeTypes.CRAFTING);
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registry) {
        registry.addRecipeCatalyst(WUTHandler.wirelessTerminals.get("crafting").universalTerminal(), RecipeTypes.CRAFTING);
    }
}
